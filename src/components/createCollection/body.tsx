  ...
  return (
    <Box>
      ...
      <Box mt='30px'>
        ...
        <Text mt='10px'>
          Adding a category will help make your item discoverable on NFT Raptors
        </Text>
            ...
            <AccordionPanel pb={4}>
              ...
              >
                <RadioGroup defaultValue='1' onChange={(e) => setCategory(e)}>
                  <Stack spacing='15px'>
                    <Radio value='art' size='lg' colorScheme='messenger'>
                      Art
                    </Radio>
                    <Radio
                      value='tradingcars'
                    ...
                    <Radio value='sports' size='lg' colorScheme='messenger'>
                      Sports
                    </Radio>
                    <Radio
                      value='virtualworlds'
